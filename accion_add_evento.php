<?php	
	...
	if (isset($_SESSION["evento"])) {
        ...
        $excepcion = añadirEvento($conexion, $evento["nombre"], $evento["fecha"], $evento["horaInicio"], $evento["horaFin"], $evento["lugar"],
         $evento["numeroAsistentes"], $evento["tipo"], $evento["cif"], $evento["supervisor"]);
